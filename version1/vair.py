...
class Title_Rabbit:
    ...
    def update(self, _):
        ...
        # increments the array to use the next image %(mod) the length of the array
        self.frame += 1
        self.sprite = py.sprite.Sprite(
            img=self.title_seq[self.frame % self.frameMAX], x=280, y=250)
...
class Title_Text:
    ...
    def update(self, _):
        ...
        self.frame += 1
        self.sprite = py.sprite.Sprite(
            img=self.title_seq[self.frame % self.frameMAX], x=367, y=320)
...
class Title_Text_Alt:
    ...
    def update(self, _):
        ...
        self.frame += 1
        self.sprite = py.sprite.Sprite(
            img=self.title_seq[self.frame % self.frameMAX], x=365, y=313)
...
class Sprite_Rabbit:
    ...
    def update(self, _):
        ...
        self.sprite = py.sprite.Sprite(
            img=self.img_seq[currentFrame], x=self.x, y=self.y)
...
class Sprite_Fox:
    ...
    def update(self, _):
        ...
        currentFrame = self.frame % self.frameMAX
        self.sprite = py.sprite.Sprite(
            img=self.img_seq[currentFrame], x=420, y=140)
        self.sprite.scale = 0.6
