...
health_bar = py.shapes.Rectangle(x=STATS_BUFFER, y=health_txt.y, width=thlay.get_bar_width() * 50, height=12, color=(255, 0, 0), batch=batch_stats)
stomach_bar = py.shapes.Rectangle(x=STATS_BUFFER, y=stomach_txt.y, width=flay.get_bar_width() * 50, height=12, color=(0, 100, 0), batch=batch_stats)
poop_bar = py.shapes.Rectangle(x=STATS_BUFFER, y=poops_txt.y, width=hraka.get_bar_width() * 50, height=12, color=(128, 128, 0), batch=batch_stats)
